...
<template>
  <div class="exam">
    <el-table :data="pagination.records" style="width: 100%" height=75vh  :cell-style="cellStyle" :header-cell-style="rowClass" >
      ...
      <el-table-column prop="description" label="课程目标" width="200"></el-table-column>
      <el-table-column prop="institute" label="教师姓名" width="120"></el-table-column>
      <el-table-column prop="major" label="课程摘要" width="200"></el-table-column>
