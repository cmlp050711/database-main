    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        ...
        <div class="change" v-if="optionValue === '选择题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>请在下面的输入框中输入题目内容,如1+1的值是()</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="title">
            <el-tag type="success">解析:</el-tag><span>在下面的输入框中输入答案解析</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="submit">
            <el-button type="primary" @click="changeSubmit()">添加</el-button>
        ...
        <div class="change fill" v-if="optionValue === '填空题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>请在下面的输入框中输入题目内容,如1+()的值是2。[注:考生答题部分一定要用英文半角括号]</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="submit">
            <el-button type="primary" @click="fillSubmit()">添加</el-button>
            <el-button type="danger" @click="cancel()">取消</el-button>
          </div>
        </div>
        <!-- 判断题 -->
        <div class="change judge" v-if="optionValue === '判断题'">
          ...
          <div class="title">
            <el-tag type="success">解析:</el-tag><span>在下面的输入框中输入题目解析</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="submit">
            <el-button type="primary" @click="judgeSubmit()">添加</el-button>
            <el-button type="danger" @click="cancel()">取消</el-button>
          </div>
        </div>
      </section>
    ...
    <el-tab-pane name="second">
      ...
      <div class="box">
        <ul style="display: flex">
          <li>
            <span>试题难度:</span>
            <el-select v-model="difficultyValue" placeholder="试题难度" class="w150" style="width: 100px">
              <el-option
          ...
          <li>
            <span style="margin-left: 30px">选择题数量：</span> <el-input type="text" v-model="changeNumber" style="width: 100px"></el-input>
          </li>
          <li>
            <span style="margin-left: 30px">填空题数量：</span> <el-input type="text" v-model="fillNumber" style="width: 100px"></el-input>
          </li>
          <li>
            <span style="margin-left: 30px">判断题数量：</span> <el-input type="text" v-model="judgeNumber" style="width: 100px"></el-input>
          </li>
          <li>
            <el-button type="primary" @click="create()" style="margin-left: 50px">组卷</el-button>
            <el-button type="danger" @click="cancel()">取消</el-button>
          </li>
        </ul>
<!--        <div style="margin-top: 100px; margin-left: 300px">-->
<!--          <el-button type="primary" @click="create()">组卷</el-button>-->
<!--          <el-button type="danger" @click="cancel()">取消</el-button>-->
<!--        </div>-->
      </div>
    </el-tab-pane>
