    ...
    <!--顶部信息栏-->
     <div class="top">
       <ul class="item">
         <li>
           <div class="logo">
             <a><img src="static/picture/logo.png" alt="img" ref="toggle" @click="slider_flag = !slider_flag" style="font-size: larger; width: 50px; height: 35px"></a></div>
         </li>
<!--           </div><img src="static/image/" class="iconfont el-icon-bicycle" ref="toggle" @click="slider_flag = !slider_flag" style="font-size: larger"></img></li>-->
         <li style="padding-top: 6px; font-size: 18px; font-weight: bold; color: white">{{examData.type}}-{{examData.source}}</li>
         <li>
           <div class="examInfo" style="display:flex;font-size: 16px; font-weight: bold">
              <i class="iconfont el-icon-bicycle" style="padding-top: 11px">&nbsp;&nbsp;</i>
              <p style="padding-top: 8px">考生姓名：{{userInfo.name}}&nbsp;&nbsp;</p>
              <p style="padding-top: 8px">&nbsp;准考证号：{{userInfo.id}}</p>
           </div>
         </li>
       </ul>
     </div>
     <div class="flexarea">
        ...
        <div class="right">
          <div class="title">
            ...
            <span style="color: #005cbf">全卷共{{topicCount[0] + topicCount[1] + topicCount[2]}}题  <i class="iconfont icon-time"></i>倒计时：<b>{{time}}</b>分钟</span>
          </div>
          <div class="content">
...
.l-bottom .final {
  ...
  text-align: center;
  background: linear-gradient(to right, #9fcdff 30%,whitesmoke);
